...
// import {View, Text, Pressable, Image, StyleSheet, Alert, ListRenderItem, FlatList, ActivityIndicator} from 'react-native';
...
//       const label = loading.mode === "Add" ?
//       "Adding student" : "Saving Changes";

//       return (
//         <View style = {[styles.footer, {backgroundColor: theme.background}]}>
//           <ActivityIndicator size={'large'} color={theme.accent}/>
//           <Text style = {[styles.textLoading, {color: theme.textPrimary}]}> {label} {loading.secondsLeft}s </Text>
//         </View>
//       )
